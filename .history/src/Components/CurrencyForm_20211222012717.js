        ...
        <div className='currency-form-container'>
            <form className='currency-form'>
                <div className='currency-form-group'>
                    <div>
                        <input className='fr-currency' onChange={event => setFrAmount(event.target.value)} placeholder='Enter The Amount' />
                ...
                <div className='currency-form-group'>
                    <input className='sec-currency' onChange={event => setFrAmount(event.target.value)} placeholder='Enter The Amount' />
