...
export default function Currency() {
    ...
    function format(number) {
      ...
      function onChangeFrAmount(frAmount) {
        sesecAmount(format(frAmount * currencyExchange['USD'+secCurrency] / currencyExchange['USD'+frCurrency]));
        setFrAmount(frAmount);
      }
    
      function onChangeFrCurrency(frCurrency) {
        secAmount(format(frAmount * currencyExchange['USD'+secCurrency] / currencyExchange['USD'+frCurrency]));
        setFrAmount(frAmount);
        
      }
    
      function onChangeSecAmount(secAmount) {
        frAmount(format(secAmount * currencyExchange['USD'+secCurrency] / currencyExchange['USD'+secCurrency]));
