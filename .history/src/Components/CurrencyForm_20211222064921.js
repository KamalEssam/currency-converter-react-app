    ...
    return (
        <div className='currency-form-container'>
            <form className='currency-form'>
                <div className='currency-form-group'>
                    <div>
                        ...
                        <select className='select-fr-currency' value={props.frCurrency} onChange={ev => props.onFrCurrencyChange(ev.target.value)}  >
                                    ...
                                    <option value={props.frCurrency}> {props.frCurrency} </option>
                ...
                <div className='currency-form-group'>
                    <input className='sec-currency' value={props.secAmount} onChange={ev => props.onFrAmountChange(ev.target.value)}  placeholder='Enter The Amount' />
