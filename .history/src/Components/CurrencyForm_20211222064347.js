        ...
        <div className='currency-form-container'>
            <form className='currency-form'>
                <div className='currency-form-group'>
                    <div>
                        <input className='fr-currency' value={props.amount} onChange={ev => props.onfrAmountChange(ev.target.value)}  placeholder='Enter The Amount' />
                        <select className='select-fr-currency' onChange={onChangeFrCurrency}  >
                            
                                    <option value={frCurrency}> {frCurrency} </option>
